 ...
 */
final class Version20200808095854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick DROP image_url');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD image_url VARCHAR(255) DEFAULT NULL');
    }
}
